        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/history" className="text-gray-400 hover:text-white transition-colors">历史频道</a></li>
              <li><a href="/culture" className="text-gray-400 hover:text-white transition-colors">文化频道</a></li>
              <li><a href="/academic" className="text-gray-400 hover:text-white transition-colors">学术研究</a></li>
              <li><a href="/community" className="text-gray-400 hover:text-white transition-colors">互动社区</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2">
                ...
                <span>contact@chinahistory.com</span>
              </li>
              <li className="flex items-center space-x-2">
